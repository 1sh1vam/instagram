...
export default function ProfilePopUp() {
    ...
    return (
        <div className="flex flex-col profile-popup">
            ...
            <Link className="pl-5 pt-1 pb-1 mb-2 cursor-pointer flex items-center">
            ...
            <hr/>
            <button className="pl-5 pt-2 pb-2 text-left cursor-pointer outline-none">Log Out</button>
        </div>
    )
}